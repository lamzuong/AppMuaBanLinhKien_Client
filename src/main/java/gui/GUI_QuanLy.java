...
public class GUI_QuanLy extends JFrame implements MouseListener {
	private JLabel lblDangXuat;
	private JLabel lblDoiMatKhau;
	private HoaDonDao hoaDonDao;

	public GUI_QuanLy() throws RemoteException {
		...
		JPanel panelNhanVien = frameNV.createPanelNhanVien();
		...
		tabbedPane.addTab("QUẢN LÝ NHÂN VIÊN", new ImageIcon("image/nhanvien.png"), panelNhanVien, "QUẢN LÝ NHÂN VIÊN");
